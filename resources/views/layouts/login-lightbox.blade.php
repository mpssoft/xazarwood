...
<div id="lightboxOverlay" class="fixed inset-0 bg-black/50 lightbox-overlay hidden z-50">
    <!-- Lightbox Content -->
    <div class="w-[90%] lightbox-content fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-wood-50 via-wood-100 to-wood-200 dark:from-wood-900 dark:via-wood-800 dark:to-wood-950 rounded-2xl shadow-2xl max-w-md mx-auto" onclick="event.stopPropagation()">
        <!-- Header -->
        <div class="p-8 pb-6">
            ...
            <div class="text-center mb-6">
                ...
                <h2 class="text-3xl font-bold text-wood-800 dark:text-wood-100">{{__('Login by phone')}}</h2>
            </div>
            <p class="text-wood-600 dark:text-wood-300 mb-8 text-center">{{__('Enter your mobile number to receive the verification code')}}</p>
            ...
            <form id="otpForm" class="space-y-6">
                ...
                <div id="mobileStep" class="space-y-6">
                    <div id="mobileSection">
                        <label for="mobile" class="block text-sm font-medium text-wood-600 dark:text-wood-400 mb-2">{{__('Phone number')}}</label>
                        <input
                            type="tel"
                            id="mobile"
                            name="mobile"
                    ...
                    <div id="otpCodeBox" class="hidden">
                        ...
                        <label class="block text-wood-600 dark:text-wood-300 text-sm font-medium mb-2">
                            <i class="fas fa-key mr-2"></i> {{__('Confirmation code')}}
                        </label>
                    ...
                    <button type="submit"
                        ...
                        <span class="btn-text">{{__('Send verification code')}}</span>
                    ...
                    <div id="timerBox" class="text-center text-amber-600 dark:text-amber-400 mt-4 hidden">
                         <span id="timer">60</span> {{__('Please wait ...')}}
                    </div>
                </div>
            </form>
        </div>
