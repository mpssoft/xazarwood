...
<header class="flex w-full justify-between items-center px-6 py-4  bg-gradient-to-b from-white  to-wood-100 dark:from-wood-800  dark:to-wood-900 shadow-[0_4px_12px_rgba(0,0,0,0.15)] dark:shadow-[0_4px_12px_rgba(0,0,0,0.4)] sticky top-0 z-50 backdrop-blur-sm">
 ...
 --}}
        ...
        <button @click="dark = !dark"  class="p-2 rounded-lg bg-wood-200 dark:bg-wood-800 text-wood-800 dark:text-wood-200 hover:bg-wood-300 dark:hover:bg-wood-700 smooth-transition" aria-label="Toggle dark mode">
            <svg x-show="!dark" class="w-6 h-6 " fill="none" stroke="currentColor" viewbox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <svg  x-show="dark" class="w-6 h-6 " fill="none" stroke="currentColor" viewbox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
            </svg></button>
