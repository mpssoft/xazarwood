...
>
    ...
    <nav class="flex flex-col gap-2 px-4 text-sm md:text-base mt-6 sticky top-20">
        ...
        <a href="{{route('user.addresses.index')}}" class="flex items-center gap-3 px-5 py-3 rounded-xl hover:bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 dark:hover:from-pink-900/20 dark:hover:to-purple-900/20 hover:-tranwood-x-1 transition-all duration-300 group">
            <i class="fas fa-address-book text-teal-500 group-hover:text-teal-600 transition-colors duration-200 w-5"></i>
            <span class="font-medium text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white"> آدرس های من </span>
        </a>
