    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-8">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center">
                <i class="fas fa-users-plus text-white text-xl"></i>
            </div>
            <div>
                <h1 class="text-xl font-bold text-gray-900 dark:text-white">ایجاد گروه کاربری جدید</h1>
                <p class="text-xs text-gray-600 dark:text-gray-400">گروه جدید ایجاد کنید و کاربران را اضافه نمایید</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form id="createGroupForm" class="space-y-6" method="post" action="{{route('admin.groups.store')}}">
                    <!-- Group Name -->
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-8 gap-2">
                            <button type="button" onclick="selectIcon('fa-users')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition bg-purple-100 dark:bg-purple-900 border-purple-500">
                                <i class="fas fa-users text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-crown')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-crown text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-gem')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-gem text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-star')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-star text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-heart')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-heart text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-shield')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-shield text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-briefcase')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-briefcase text-gray-600 dark:text-gray-400"></i>
                            </button>
                            <button type="button" onclick="selectIcon('fa-graduation-cap')" class="icon-option p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-purple-100 dark:hover:bg-purple-900 transition">
                                <i class="fas fa-graduation-cap text-gray-600 dark:text-gray-400"></i>
                            </button>
                        </div>
                        <input type="hidden" id="selectedIcon" name="icon" value="fa-users">
                    </div>
                    ...
                    <div class="flex gap-4 pt-6">
                        ...
                        <button type="submit"
                                class="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-indigo-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition shadow-lg">
                            <i class="fas fa-save ml-2"></i>
                            <span id="submitButtonText">ایجاد گروه</span>
                        </button>
                    </div>
                </form>
            </div>
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white">اعضای گروه</h3>
                        </div>
                        <span id="userCount" class="px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-full text-xs font-medium">
                ۰ کاربر
              </span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div id="selectedUsersList" class="space-y-3">
                        ...
                        <div id="emptyUsersState" class="text-center py-8">
                            ...
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-2">هنوز کاربری اضافه نشده</h4>
