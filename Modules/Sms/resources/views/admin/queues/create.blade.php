    ...
    <div class="grid grid-cols-1   gap-8">
        ...
        <div class="">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form id="smsForm" class="space-y-6" method="post" action="{{route('admin.sms_queues.store')}}">
                    <!-- Recipient Type -->
                    @csrf
                    <div>
                        ...
                        <select id="recipientType" name="type" onchange="handleRecipientTypeChange()"
                            ...
                            <option value="singleuser">کاربر منفرد</option>
                            <option value="group">گروه کاربران</option>
                    ...
                    <div>
                        ...
                        <textarea id="messageContent" name="message"
                                  ...
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none transition"></textarea>
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                  <span id="charCount">۰</span>/۱۶۰ کاراکتر
                    ...
                    <button type="submit"
                        ...
                        <span id="sendButtonText"> ایجاد صف</span >
                    </button>
                </form>
            </div>
        </div>
...
<script>
    ...
    function handleScheduleChange() {
        ...
        if (scheduleType === 'scheduled') {
            ...
            sendButtonText.textContent = 'ایجاد زمانبندی صف';
            ...
            sendButtonText.textContent = 'ایجاد صف';
        }
    }
