...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="form-section text-white py-6 px-8 rounded-2xl shadow-lg mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-lg opacity-90">فایل جدید خود را آپلود کرده و اطلاعات آن را تکمیل کنید</p>
            </div>
    ...
    <!-- Main Form -->
    <form id="file-form" class="space-y-8" action="{{route('admin.files.store')}}" method="post">
        @csrf
        ...
        <div class="form-section p-8">
            ...
            <div class="flex items-stretch space-x-2">
                <input type="text" id="image_label" name="file_path"
        ...
        <div class="mt-6">
            ...
            <div class="mb-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span id="selected-icon-name" class="font-medium text-gray-900 dark:text-white mr-2">فایل عمومی</span>
                    </div>
                </div>
            </div>
            ...
            <input type="hidden" name="icon" id="file-icon-input" value="fas fa-file">
        ...
        <div class="form-section p-8">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <label class="access-option relative flex items-center p-6 border-2 border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-purple-300 transition">
                        <input type="radio" name="access_type" value="free" class="sr-only" required>
                    ...
                    <!-- Paid Access -->
                    <label class="access-option relative flex items-center p-6 border-2 border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-purple-300 transition">
                        <input type="radio" name="access_type" value="paid" class="sr-only" required>
                        <div class="flex items-center w-full">
                            <div class="w-6 h-6 border-2 border-purple-600 rounded-full ml-4 flex items-center justify-center">
                                <div class="w-3 h-3 bg-transparent rounded-full transition"></div>
                            </div>
            ...
            <div id="price-section" class="hidden">
                ...
                <div class="mt-2 text-sm text-gray-500">
                    <p>حداقل قیمت: 1,000 تومان</p>
                    <p>قیمت‌های پیشنهادی: 10,000 - 50,000 - 100,000 تومان</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-section p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <label class="status-option relative flex items-center p-6 border-2 border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-purple-300 transition">
                    <input type="radio" name="state" value="active" class="sr-only" checked required>
                    <div class="flex items-center w-full">
                        <div class="w-6 h-6 border-2 border-purple-600 rounded-full ml-4 flex items-center justify-center">
                ...
                <!-- Inactive Status -->
                <label class="status-option relative flex items-center p-6 border-2 border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-purple-300 transition">
                    <input type="radio" name="state" value="inactive" class="sr-only" required>
                    <div class="flex items-center w-full">
                        <div class="w-6 h-6 border-2 border-purple-600 rounded-full ml-4 flex items-center justify-center">
                            <div class="w-3 h-3 bg-transparent rounded-full transition"></div>
                        </div>
...
<script>
    ...
    fileForm.addEventListener('submit', function(e) {
        ...
        // Add file path (in real app, this would be handled by server)
        if (fileInput.files.length > 0) {
            formData.append('file_path', '/uploads/' + fileInput.files[0].name);
        }
