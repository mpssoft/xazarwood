        ...
        <div class="px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-slate-100">کپی محصول </h1>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form id="product-form" class="space-y-8" action="{{route('admin.products.store')}}" method="post" onsubmit="removeComas()">
@csrf
        @method('post')
        <!-- Basic Information -->
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 sm:space-x-reverse">
                ...
                <button type="submit" class="px-6 py-3 bg-green-600 dark:bg-green-700 hover:bg-green-700 dark:hover:bg-green-600 text-white rounded-lg font-medium transition-colors">
                    <i class="fas fa-check ml-2"></i>ثبت  محصول
                </button>
            </div>
        </div>
