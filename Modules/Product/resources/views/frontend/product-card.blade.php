        ...
        <div class="flex flex-col h-full  p-2 ">
            ...
            @if($product->stock == 0 || $product->status == 'inactive')
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-3 ">
                    <div class="flex md:flex-col items-center justify-between gap-3">
                        <span class="text-xl font-bold text-gray-700 dark:text-gray-400">{{number_format($product->price)}}</span>
                        <span class="text-xs text-gray-700 dark:text-gray-400">تومان</span>
                    </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-3">
                    @if($activeDiscount)
                        <div class="flex justify-between items-center">
                            <div class="flex flex-col text-right">
                                ...
                                </div><span class="text-xs text-gray-800 dark:text-slate-200">تومان</span>
                            </div>
                    ...
                    @else
                        ...
                        <div class="flex md:flex-col items-center justify-between gap-3">
                            ...
                            <span class="text-xs text-amber-700 dark:text-amber-400">تومان</span>
                        </div>
                    @endif
                    <button id="btn-{{$product->id}}"
