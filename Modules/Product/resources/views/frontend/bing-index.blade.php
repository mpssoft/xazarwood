...
<div class="grid grid-cols-1 md:grid-cols-6 max-w-7xl mx-auto h-full gap-2">
        ...
        <div class="mb-6 mt-3">
            ...
            <ul class="space-y-1">
             @foreach(\Modules\Blog\Models\Category::all() as $category)
                <li><label><input type="checkbox" value="{{$category->id}}" class="mr-2">{{$category->name}}</label></li>
                @endforeach
            </ul>
        </div>
    ...
    <!-- بخش محصولات -->
    <main class="col-span-5  p-2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 grid-rows-[max-content] gap-2">
