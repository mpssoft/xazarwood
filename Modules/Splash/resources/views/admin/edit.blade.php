...
<main class="max-w-5xl mx-auto px-4 sm:px-6 py-8">
    <header class="bg-white mb-5 dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-5 flex items-center justify-between">
            <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight">ویرایش اسپلش  </h1>
    ...
    <div class="grid  gap-8 items-start">
        ...
        <section class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <form id="splashForm" class="px-6 py-6 space-y-6" action="{{route('admin.splashes.update',$splash->id)}}" method="post">
                @csrf
                @method('put')
                <!-- Splash Title -->
                <div class="group">
                    ...
                    <input type="text" name="title" value="{{old('title',$splash->title)}}"
                ...
                <div class="space-y-2">
                    ...
                    <div id="dropZone"
                        ...
                        <div class="flex items-stretch space-x-2 gap-2">
                            <input type="text" id="image_label" name="image" dir="ltr" value="{{old('image',$splash->image)}}"
                ...
                <div>
                    ...
                    <input id="linkUrl" name="link" type="text" dir="ltr" value="{{old('link',$splash->link)}}"
                ...
                <div class="group">
                    ...
                    <select name="active"
                        ...
                        <option value="1" {{$splash->active == 1 ? 'selected':''}}>فعال</option>
                        <option value="0" {{$splash->active == 0 ? 'selected':''}}>غیر فعال</option>
                    </select>
                    @error('teacher_id')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
